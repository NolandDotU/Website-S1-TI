          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
            ...
            {showForm && (
              <m.div
                  ...
                  <form onSubmit={handleBeritaSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          value={beritaForm.id}
                          onChange={(e) =>
                            setBeritaForm({ ...beritaForm, id: e.target.value })
                          }
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setBeritaForm({ ...beritaForm, link: e.target.value })
                        }
                        className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:outline-none focus:border-blue-500"
                        required
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setBeritaForm({ ...beritaForm, foto: e.target.value })
                        }
                        className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:outline-none focus:border-blue-500"
                        required
                      />
                  ...
                  <form onSubmit={handleDosenSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setDosenForm({ ...dosenForm, photo: e.target.value })
                        }
                        className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:outline-none focus:border-blue-500"
                        required
                      />
                ...
                {activeTab === "profil" && (
                  <form
                    onSubmit={handleProfilProdiSubmit}
                    className="space-y-4">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Update Profil Program Studi
                    </h3>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={(e) =>
                          setProfilProdiForm({
                            ...profilProdiForm,
                            dokumen_akreditasi_detail: e.target.value,
                          })
                        }
                        rows="3"
                        className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:outline-none focus:border-blue-500"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setProfilProdiForm({
                            ...profilProdiForm,
                            dokumen_akreditasi_gambar: e.target.value,
                          })
                        }
                        className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:outline-none focus:border-blue-500"
                        required
