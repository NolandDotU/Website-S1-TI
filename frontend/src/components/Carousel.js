...
const defaultSlides = [
  { id: 1, img: image1, label: 'Fakultas Teknologi Informasi', subtitle: 'Membangun Masa Depan Digital' },
  { id: 2, img: image1, label: 'Inovasi & Riset', subtitle: 'Mendorong Transformasi Teknologi' },
  { id: 3, img: image1, label: 'Berdiri Sejak 2003', subtitle: 'Program Studi S1 Teknik Informatika' },
];
          ...
          {slides.map((_, i) => (
            ...
            >
              <div className={`h-1 rounded-full transition-all duration-500 ${
                i === index ? 'w-12 bg-white' : 'w-8 bg-white/50 hover:bg-white/70'
              }`} />
            </button>
          ))}
        </div>
